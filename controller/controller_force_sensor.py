...
class Controller_force_sensor(Controller_base):
    def __init__(self, model, userinterface):
        ...
        self.model.force_sensor.add_event_listener("activate_force_sensor",self.activate_force_sensor)
    ...
    def retrieve_data_left(self, force_sensor: Force_sensor):
        ...
        logger.debug(f"longWithOffsetValue: {force_sensor.longWithOffset_left} | weight (grams): {force_sensor.weightValue_left} | {force_sensor.category_left}")
    ...
    def update_measurement_category(self, force_sensor: Force_sensor):
        ...
        if force_sensor.category_left == "STRONG":
            suturing_force_page.itemconfigure(suturing_force_page.box_suturing_force_left,fill="fill=#FF0000")
